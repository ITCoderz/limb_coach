...
class EditProfileController extends GetxController {
  ...
  final priceControllers = <String, TextEditingController>{
    "Per Hour": TextEditingController(text: '100'),
    "Per Session": TextEditingController(text: '10'),
  };
  ...
  void updatePrice(String type, String value) {
    priceControllers[type]?.text = value;
  }
  ...
  void onClose() {
    ...
    priceControllers.forEach((_, c) => c.dispose());
    super.onClose();
  }
}
